...
pub static ref KERNELS: HashMap<&'static str, &'static str> = {
    ...
    m.insert("sgemm_bt_scalar", include_str!(r"../kernels/sgemm_bt_scalar.wgsl"));
    ...
    m.insert("qgemm_bt_vec4", include_str!(r"../kernels/qgemm_bt_vec4.wgsl"));
    ...
    m.insert("sgemm_bt_vec2", include_str!(r"../kernels/sgemm_bt_vec2.wgsl"));
    m.insert("sgemm_vec2", include_str!(r"../kernels/sgemm_vec2.wgsl"));
    m.insert("softmax_vec2", include_str!(r"../kernels/softmax_vec2.wgsl"));
    m.insert("sgemm_bt_vec4", include_str!(r"../kernels/sgemm_bt_vec4.wgsl"));
